...
Hit points are dumb. And most combat actions that don't deal damage just aren't worth doing. The goal isn't to find a solution to a problem; the goal is to grind the enemies' hit points down to zero.
